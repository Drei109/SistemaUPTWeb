...
//    ArrayList<String> datosObservacionesP4 = new ArrayList<>();
    ...
    String materal = request.getParameter("usoAulamaterialcurso") != null ? "Si" : "No";
    String foros = request.getParameter("usoAulaforos") != null ? "Si" : "No";
    String cuestionarios = request.getParameter("usoAulacuestionarios") != null ? "Si" : "No";
    String examenes = request.getParameter("usoAulaexamenesvirtuales") != null ? "Si" : "No";
    String tareas = request.getParameter("usoAulatareasencargadas") != null ? "Si" : "No";
    String ppt = request.getParameter("usoAulaslideshow") != null ? "Si" : "No";
    String total = materal + "," + foros + "," + cuestionarios + "," + examenes + "," + tareas + "," + ppt;
    
    int p = 0;
    int idObs = 1;
    for (int i = 0; i < datosObservaciones.size(); i++) {
