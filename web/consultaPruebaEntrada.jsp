                                                    ...
                                                    while (rs.next()) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <% } 
                                                                ...
                                                                <td> <a href="/SistemaInformesUPTWeb/InfoFinalControls/ListarInfoFinal.jsp?id_Final=<%= rs.getString(1)%>" class="btn btn-success btn-xs btn-controles">Ver Informe F</a></td>
                                                            <% } %>
                                                        </tr>
                                                        <%
